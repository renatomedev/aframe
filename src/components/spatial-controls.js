...
var GAMEPAD_ID_PREFIX = 'Spatial Controller ';

/**
 * Spatial controls.
 * Interface with Spatial controllers and map Gamepad events to controller buttons:
 * trackpad, trigger, grip, menu, thumbstick
 * Load a controller model and highlight the pressed buttons.
 */
module.exports.Component = registerComponent('spatial-controls', {
  schema: {
    hand: {default: 'left'},
  ...
  mapping: {
    axes: {trackpad: [0, 1]},
    buttons: ['trigger', 'menu', 'grip', 'thumbstick', 'trackpad']
  },
  ...
  onModelLoaded: function (evt) {
    ...
    buttonMeshes.thumbstick = controllerObject3D.getObjectByName('systembutton');
